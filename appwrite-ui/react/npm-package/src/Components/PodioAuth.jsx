...
const PodioAuth = ({account, successUrl, failureUrl}) => {
  return (
    <AuthButton account={account} authProvider='podio' btnClassName='appwriteui-react-podio-auth-btn' displayText='Sign in with Podio' successUrl={successUrl} failureUrl={failureUrl} icon={<PodioSvg className='icon'/> }   />
  )
}
